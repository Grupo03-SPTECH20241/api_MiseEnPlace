...
public class ProdutoMapper {
    ...
    public static ProdutoListagemDTO toListagemDto(Produto produto){
        ...
        massaDto.setId(produto.getMassa().getIdMassa());
        ...
        coberturaDto.setId(produto.getCobertura().getIdCobertura());
        ...
        unidadeMedidaDto.setId(produto.getUnidadeMedida().getIdUnidadeMedida());
        ...
        tipoProdutoDto.setId(produto.getTipoProduto().getIdTipoProduto());
